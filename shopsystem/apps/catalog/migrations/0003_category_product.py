...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0002_auto_20151126_2054'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_keywords', models.CharField(max_length=255, verbose_name='Meta关键词', help_text='meta关键词，有利于SEO，用逗号分隔')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_description', models.TextField(max_length=255, verbose_name='Meta描述', help_text='meta 描述标签')),
                ('created_at', models.DateTimeField(verbose_name='创建时间', auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
